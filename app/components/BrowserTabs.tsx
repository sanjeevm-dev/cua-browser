      ...
      >
        {pages.map((page) => (
          <div
            ...
            className={cn(
              "bg-black/[0.3] backdrop-blur-xl rounded-lg text-white/90 border border-white/[0.08] text-sm flex gap-x-1 py-1.5 px-2 max-w-[300px] cursor-pointer hover:border-white/[0.15] transition-all",
              {
